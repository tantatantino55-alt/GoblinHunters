...
import goblinhunters.utils.ScoreEntry;
...
public class GameOverDrawer {
    ...
    /** Returns the ClickResult for the button at the given screen coordinates. */
    ...
    private int drawTitle(Graphics2D g2d, int panelX, int cy) {
        ...
        // subtle drop shadow for the neon dramatic look
    ...
    private void drawLeaderboard(Graphics2D g2d, int panelX, int cy) {
        List<ScoreEntry> top = ControllerForView.getInstance().getTopScores();
